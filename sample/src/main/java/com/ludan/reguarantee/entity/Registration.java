...
public class Registration extends BaseEntityFill {
    ...
    */
    @ApiModelProperty(value = "业务编号")
        @ExcelDefine(columnName = "业务编号")
    private String code;
    /**
    * 客户名称
    */
    @ApiModelProperty(value = "客户名称")
        @ExcelDefine(columnName = "客户名称")
    private String custName;
    /**
    * 客户性质 取字典值
    */
    @ApiModelProperty(value = "客户性质 取字典值")
        @ExcelDefine(columnName = "客户性质 取字典值",dictCode = "custNature")
    private String custNature;
    /**
    * 客户证件号类别 取字典值
    */
    @ApiModelProperty(value = "客户证件号类别 取字典值")
        @ExcelDefine(columnName = "客户证件号类别 取字典值",dictCode = "custCertType")
