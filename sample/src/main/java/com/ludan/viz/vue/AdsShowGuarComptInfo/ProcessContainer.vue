...
//import AdsShowGuarComptInfoDetail from './components/AdsShowGuarComptInfoDetail'
 import { baseMixin } from '@/store/app-mixin'
import RealForm from './components/AdsShowGuarComptInfoForm'
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        detail: "/api-sample/AdsShowGuarComptInfo/detail/"
      },
      tabList: [
          { key: 'detail', tab: '详情' },
          /* { key: 'rule', tab: '规则' } */
