...
<script>
    ...
    import ModalForm from './components/AdsShowGuarComptInfoModal' // 切换到抽屉模式 引用改为 './drawer.vue'
    ...
    export default {
        ...
        data() {
            return {
                ...
                pageDict: {},
                url: {
                    list: '/api-sample/AdsShowGuarComptInfo/list',
                    delete: '/api-sample/AdsShowGuarComptInfo/delete',
                    deleteBatch: '/api-sample/AdsShowGuarComptInfo/deleteBatch',
                    exportXlsUrl: '/api-sample/AdsShowGuarComptInfo/exportXlsx',
                    importExcelUrl: '/api-sample/AdsShowGuarComptInfo/importExcel'
                }
            }
        },
        filters: {},
