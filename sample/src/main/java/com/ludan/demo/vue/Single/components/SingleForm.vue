        ...
        <a-form :form="form" v-bind="formLayout">
          <a-row :gutter="26" :style="rowStyle">
            <!-- 检查是否有 id 并且大于0，大于0是修改。其他是新增，新增不显示主键ID -->
                        ...
                        <a-col :span="12" :style="colStyle">
                            <a-form-item label="propInt" v-bind="colInfo12">
                                    <a-input-number v-decorator="['propInt',validatorRules.propInt ]" style="width:100%" :disabled="unEditable"/>
                            </a-form-item>
                        </a-col>
                        <a-col :span="12" :style="colStyle">
                            <a-form-item label="propString" v-bind="colInfo12">
                                    <a-input v-decorator="['propString',validatorRules.propString ]" :disabled="unEditable"/>
                            </a-form-item>
                        </a-col>
                        <a-col :span="12" :style="colStyle">
                            <a-form-item label="propBool" v-bind="colInfo12">
                                    <a-checkbox-group v-decorator="['propBool']" style="width: 100%;" :disabled="unEditable">
                                        <a-row>
                                            <a-col :span="8" >
                                            未设置字典编码
                                            </a-col>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            validatePropInt (rule, value, callback) {
                callback()
                // callback('请输入正确的格式的propInt')
            },
            validatePropString (rule, value, callback) {
                callback()
                // callback('请输入正确的格式的propString')
            },
            validatePropBool (rule, value, callback) {
                callback()
                // callback('请输入正确的格式的propBool')
            },
