            ...
            <!-- 检查是否有 id 并且大于0，大于0是修改。其他是新增，新增不显示主键ID -->
                ...
                <a-form-item label="下拉单选">
                                <a-select v-decorator="['selectOne',validatorRules.selectOne ]">
                                    ...
                                    <a-select-option v-for="(item, name) in pageDict.projectSource" :key="name"
                                                     :value="item.code">
                                        {{ item.value }}
                                    </a-select-option>
                                </a-select>
                ...
                <a-form-item label="下拉多选">
                                <a-select v-decorator="['selectMany',validatorRules.selectMany ]" mode="multiple">
                                    <a-select-option v-for="(item, name) in pageDict.mainType"
                ...
                <a-form-item label="多选">
                                <a-checkbox-group
                                    ...
                                    <a-row>
                                        <a-col :span="8" v-for="(item, name) in pageDict.custType"
                                               :key="name">
                ...
                <a-form-item label="开关">
                                <a-radio-group v-decorator="['radio',validatorRules.radio]">
                                    <a-radio v-for="(item, name) in pageDict.stateSdndType" :key="name"
                                             :value="item.code">
                                        {{ item.value }}
                                    </a-radio>
                                </a-radio-group>
                ...
                <a-form-item label="日期组件">
                            <a-date-picker v-decorator="['fieldDate',validatorRules.fieldDate ]"
                                           style="width: 100%"/>
                </a-form-item>
                ...
                <a-form-item label="时间组件">
                            <a-date-picker v-decorator="['fieldTime',validatorRules.fieldTime ]"
                                           style="width: 100%"/>
                </a-form-item>
...
<script>
    ...
    export default {
        ...
        data() {
            ...
            id:
            {
                rules:[{required: false}, {validator: this.validateId}]
            }
        ,
            inputText:
            {
                rules:[{required: false}, {validator: this.validateInputText}]
            }
        ,
            number:
            {
                rules:[{required: false}, {validator: this.validateNumber}]
            }
        ,
            selectOne:
            {
                rules:[{required: false}, {validator: this.validateSelectOne}]
            }
        ,
            selectMany:
            {
                rules:[{required: false}, {validator: this.validateSelectMany}]
            }
        ,
            checkBox:
            {
                rules:[{required: false}, {validator: this.validateCheckBox}]
            }
        ,
            radio:
            {
                rules:[{required: false}, {validator: this.validateRadio}]
            }
        ,
            fieldDate:
            {
                rules:[{required: false}, {validator: this.validateFieldDate}]
            }
        ,
            fieldDateTime:
            {
                rules:[{required: false}, {validator: this.validateFieldDateTime}]
            }
        ,
            fieldTime:
            {
                rules:[{required: false}, {validator: this.validateFieldTime}]
            }
        ,
            fieldFile:
            {
                rules:[{required: false}, {validator: this.validateFieldFile}]
            }
        ,
            fieldImage:
            {
                rules:[{required: false}, {validator: this.validateFieldImage}]
            }
        ,
            textArea:
            {
                rules:[{required: false}, {validator: this.validateTextArea}]
            }
        ,
            userSelect:
            {
                rules:[{required: false}, {validator: this.validateUserSelect}]
            }
        ,
            orgSelect:
            {
                rules:[{required: false}, {validator: this.validateOrgSelect}]
            }
        ,
            richText:
            {
                rules:[{required: false}, {validator: this.validateRichText}]
            }
        ,
            region:
            {
                rules:[{required: false}, {validator: this.validateRegion}]
            }
        ,
            treeSelect:
            {
                rules:[{required: false}, {validator: this.validateTreeSelect}]
            }
        ,
            modal:
            {
                rules:[{required: false}, {validator: this.validateModal}]
            }
        ,
            creator:
            {
                rules:[{required: false}, {validator: this.validateCreator}]
            }
        ,
            createTime:
            {
                rules:[{required: false}, {validator: this.validateCreateTime}]
            }
        ,
            createName:
            {
                rules:[{required: false}, {validator: this.validateCreateName}]
            }
        ,
            updator:
            {
                rules:[{required: false}, {validator: this.validateUpdator}]
            }
        ,
            updateTime:
            {
                rules:[{required: false}, {validator: this.validateUpdateTime}]
            }
        ,
            updateName:
            {
                rules:[{required: false}, {validator: this.validateUpdateName}]
            }
        ,
        },
            urls: {
