...
import com.ludan.generator.common.domain.service.IOCrudAppService;
import com.ludan.generator.common.domain.dto.EntityDto;
import org.springframework.web.bind.annotation.*;

import java.util.List;

public class IOCrudControllerBase<TService extends IOCrudAppService<TInput , TOutput, TId>, TInput extends EntityDto<TId>, TOutput extends EntityDto<TId>, TId> extends ControllerBase implements IOCrudController<TInput, TOutput, TId> {
